...
class BackendFactory:
    ...
    def _detect_optimal_backend() -> str:
        ...
        if (device_info.get("apple_silicon", False) and 
            device_info.get("mlx_available", False)):
    ...
    def get_available_backends() -> dict:
        ...
        backends = {
            "torch": {
                "available": device_info.get("torch_available", False),
                "devices": []
            },
            "mlx": {
                "available": (
                    device_info.get("apple_silicon", False) and 
                    device_info.get("mlx_available", False)
                ),
