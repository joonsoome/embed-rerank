...
Usage:
    ...
    python3 tools/benchmark-performance.py --url http://localhost:11436 --output perf.json
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 tools/benchmark-performance.py                                      # Full benchmark
  python3 tools/benchmark-performance.py --url http://localhost:8080          # Custom URL
  python3 tools/benchmark-performance.py --stress-duration 30                 # Shorter stress test
  python3 tools/benchmark-performance.py --output benchmark-results.json      # Save results
        """
    )
