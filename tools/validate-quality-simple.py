...
Usage:
    python3 tools/validate-quality-simple.py
    python3 tools/validate-quality-simple.py --url http://localhost:11436 --output results.json
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 tools/validate-quality-simple.py                                    # Test localhost:11436
  python3 tools/validate-quality-simple.py --url http://localhost:8080        # Custom URL
  python3 tools/validate-quality-simple.py --output validation-results.json   # Save results
  python3 tools/validate-quality-simple.py --quiet                           # Minimal output
        """
    )
