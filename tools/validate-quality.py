...
Usage:
    python3 tools/validate-quality.py
    python3 tools/validate-quality.py --url http://localhost:11436 --output results.json
"""
...
async def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 tools/validate-quality.py                                    # Test localhost:11436
  python3 tools/validate-quality.py --url http://localhost:8080        # Custom URL
  python3 tools/validate-quality.py --output validation-results.json   # Save results
  python3 tools/validate-quality.py --quiet                           # Minimal output
        """
    )
